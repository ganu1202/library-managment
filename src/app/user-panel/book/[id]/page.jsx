...
export default function BookDetailsPage() {
  ...
  return (
    <div className="min-h-screen w-full max-w-[150rem] mx-auto px-4 sm:px-6 lg:px-8 bg-[#111827] text-white p-4 sm:p-6 md:p-10">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-8 items-start">
        ...
        <div className="flex flex-col justify-center w-full md:max-w-[500px]">
          <h2 className="text-3xl sm:text-4xl font-bold mb-2">{book.title}</h2>

          <div className="flex flex-wrap items-center gap-2 text-sm md:text-base text-gray-400 mb-3">
            <span>By</span>
            <span className="text-[#ffd700] font-semibold">{book.author}</span>
            <span>| Category:</span>
          ...
          <p className="text-gray-300 text-sm md:text-base leading-relaxed">
            ...
            following previous bestsellers like *The Da Vinci Code* and *Angels
            & Demons*.
          </p>
        ...
        <div className="w-full max-w-[500px] mx-auto md:mx-0">
          ...
          <div className="mt-8 p-5 rounded-xl shadow-lg bg-[#111827]">
            ...
            <p className="text-gray-300 leading-relaxed whitespace-pre-line text-sm md:text-base">
              ...
              romance, with a focus on psychic abilities, futuristic technology,
              and the complexities of relationships. The title, "People in Glass
